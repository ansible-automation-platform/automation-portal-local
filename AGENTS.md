...
| `make extensions` | generated from `portal.yaml` | Portal-only + Extensions UI + extra Quay catalog index. Image tags live in gitignored `.env`; see `docs/deployment-modes.md`. |
